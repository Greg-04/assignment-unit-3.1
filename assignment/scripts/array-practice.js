...
let favoriteFoods = ['Tacos', 'Pizza', 'Burgers', 'Steak'];
...
console.log('The number of animals are', numberOfAnimals);
...
console.log('The number of foods are', numberOfFoods);
...
console.log('The first animal is a', firstAnimal);
...
console.log('The second animal is a', secondAnimal);
...
console.log('Last animal index ? ', animalArray.length - 1);
...
let dessert = 'Strawberry Cheesecake';
favoriteFoods.push(dessert);
console.log("Added the dessert " + dessert + " to the end of list " + favoriteFoods);
...
let entree = 'Lamb gyro';
favoriteFoods.unshift(entree);
console.log('Added the entree ' + entree + ' to the beggining of ' + favoriteFoods);
console.log(`Added an entree to the beggining of: ${favoriteFoods}`);
...
//The .splice can replace a string inside an array
// the first 1 is for the index
// the second 1 is for an element
// the third is what you want to replace with, in this case "tourmaline"
